...
<section id="notice-container">
    ...
    <form action="${path}/notice/writeNoticeEnd.do" method="post" onsubmit="return noticeCheck();" enctype="multipart/form-data">
        ...
        <tr>
            <th>작성자</th>
            <td><input type="text" name="noticeWriter" value="<c:out value="${loginMember.userId}"/>" readonly></td>
        </tr>
        <tr>
            <th>첨부파일</th>
        ...
        <tr>
            <th>내 용</th>
            <td><textarea name="noticeContent" cols="47" rows="5" required></textarea></td>
        </tr>
        <tr>
            <th colspan="2">
